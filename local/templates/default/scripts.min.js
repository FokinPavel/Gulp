...
setupAsync({"server":{"url":"//api-maps.yandex.ru/2.1.56","path":"build/release","params":{"csp":null},"version":"2.1"},"preload":{"load":"package.full"},"enterprise":false,"key":undefined,"apikey":undefined,"browser":{"name":"Chrome","version":"62.0.3202","base":"Chromium","engine":"WebKit","engineVersion":"537.36","osName":"Windows 10","osFamily":"Windows","osVersion":"10.0","isMobile":false,"cssPrefix":"Webkit"},"lang":"ru_RU","languageCode":"ru","countryCode":"RU","hosts":{"api":{"main":"https://api-maps.yandex.ru/","ua":"https://yandex.ru/legal/maps_termsofuse/?lang={{lang}}","maps":"https://yandex.ru/maps/","statCounter":"https://yandex.ru/clck/","services":{"coverage":"https://api-maps.yandex.ru/services/coverage/","geocode":"https://geocode-maps.yandex.ru/","geoxml":"https://api-maps.yandex.ru/services/geoxml/","inception":"https://api-maps.yandex.ru/services/inception/","panoramaLocate":"https://api-maps.yandex.ru/services/panoramas/","search":"https://api-maps.yandex.ru/services/search/","suggest":"https://suggest-maps.yandex.ru/","regions":"https://api-maps.yandex.ru/services/regions/","route":"https://api-maps.yandex.ru/services/route/"}},"layers":{"map":"https://vec0%d.maps.yandex.net/tiles?l=map&%c&%l","sat":"https://sat0%d.maps.yandex.net/tiles?l=sat&%c&%l","skl":"https://vec0%d.maps.yandex.net/tiles?l=skl&%c&%l","stv":"https://0%d.srdr.maps.yandex.net/?l=stv&%c&v=%v&%l&action=render","sta":"https://lrs.maps.yandex.net/tiles?l=sta&%c&tm=%v&%l","staHotspot":"https://lrs.maps.yandex.net/tiles?l=stj&%c&tm=%v&%l","staHotspotKey":"%c&l=stj&tm=%v"},"traffic":"https://jgo.maps.yandex.net/","trafficArchive":"https://jft.maps.yandex.net/"},"layers":{"map":{"version":"17.10.28-0","scaled":true,"hotspotZoomRange":[13,23]},"sat":{"version":"3.352.0"},"skl":{"version":"17.10.28-0","scaled":true,"hotspotZoomRange":[13,23]},"trf":{"version":"1509685495","scaled":true},"sta":{"version":"0.28.1-0.1.3.0-0.2017.10.31.16.00.2.28.3-2.stable"},"stv":{"version":"3.79.0"}},"geolocation":{"longitude":61.40259,"latitude":55.160026,"isHighAccuracy":false,"span":{"longitude":0.402401,"latitude":0.335823}},"token":"60806db97f5cf6f66d16d42498e5cc00","sign":(function(r){function t(e){if(n[e])return n[e].exports;var o=n[e]={exports:{},id:e,loaded:!1};return r[e].call(o.exports,o,o.exports,t),o.loaded=!0,o.exports}var n={};return t.m=r,t.c=n,t.p="",t(0)})([function(r,t,n){"use strict";function e(){for(var r=["c","d","1","9","e","c","4","9","d","e","c","4","2","f","8","0","c","8","7","a","8","3","3","a","3","a","6","8","4","f","f","c","2","e","a","8","7","8","a","b"],t=[[SVGLength.SVG_LENGTHTYPE_UNKNOWN+15,SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMIDYMAX+25],[SVGUnitTypes.SVG_UNIT_TYPE_OBJECTBOUNDINGBOX+27,SVGAngle.SVG_ANGLETYPE_DEG+16],[SVGLength.SVG_LENGTHTYPE_MM+26,DOMException.INVALID_STATE_ERR-5]],n=0;n<t.length;n++){var e=t[n][0],o=t[n][1],i=r[e];r[e]=r[o],r[o]=i}return r.join("")}var o,i=n(1),u=n(2);r.exports=function(r){return o||(o=i(e())),i(u(r),o)}},function(r,t){"use strict";r.exports=function(r,t){t=t||0;for(var n=0;n<r.length;n++)t+=(t<<1)+(t<<4)+(t<<7)+(t<<8)+(t<<24),t^=r.charCodeAt(n);return t>>>0}},function(r,t){"use strict";r.exports=function(r){r=r.replace(/^.*\/\//,"");var t=r.indexOf("?");if(-1===t)return r;var n=t+1,e=r.indexOf("#",n);-1===e&&(e=r.length);var o=r.substring(n,e).split("&",1e3);return r.substring(0,n)+o.sort().join("&")+r.substring(e)}}]),"distribution":{},"version":"2.1.56","majorVersion":"2.1","cssPrefix":"ymaps-2-1-56-","coordinatesOrder":"latlong"})
})(this);
/*
     _ _      _       _
 ___| (_) ___| | __  (_)___
...
$(document).ready(function () {
  $slider = $('.advantages__slider-init');
  console.log($slider);
...
$(document).ready(function () {
  $slider = $('.advantages-leftpoor__slider-init');
...
$(document).ready(function () {
  $slider = $('.advantages-poor__slider-init');
  console.log($slider);
...
$(document).ready(function () {
  $slider = $('.advantages-rightpoor__slider-init');
...
$(document).ready(function () {
  var $allImages = $('.content__images');

  $allImages.each(function () {
    var $images = $(this).find('.content__image');
    if ($images.length > 1) {
      $images.css({ width: '48%' })
    }
  });
...
$(function(){
  ...
  function init(){
    ...
    var maps = $('.contacts__item');

    maps.each(function(){
      var self = $(this),
          map = self.find('.contacts__map'),
          center_x = map.data('center-x'),
          center_y = map.data('center-y'),
          placemark_x = map.data('placemark-x'),
          placemark_y = map.data('placemark-y'),

          id = map.attr('id'),
          zoom = map.data('zoom'),
          center = [center_x,center_y],
          placemark = [placemark_x,placemark_y],
          hint = self.find('.js-ymaps-hint').text(),
          balloon = self.find('.js-ymaps-balloon').text();

      mapDraw(id,center,placemark,hint,balloon,zoom);
    });

    function mapDraw(id,center,placemark,hint,balloon,zoom){
      var myMap,
          myPlacemark;
...
$(function(){
  $('.products-types__text-block').hover(function(){
    $(this).find('.products-types__description').slideDown();
  },function(){
    $(this).find('.products-types__description').slideUp();
  });
});

$(function(){
  (function(){
    var isMobile = window.getComputedStyle(document.body,':after').getPropertyValue('content');
    if(isMobile){
      $('.select-city__button').attr('href', '/goroda/');
    }
  })();
});

$(function(){
  $('.top-menu__mobile').on('click', function(){
  ...
  $('.top-menu__link').on('click', function(){
    ...
    if(!_this.hasClass(_class)){
      $('.top-menu__link').removeClass(_class);
      $('.two-level-menu').slideUp();
      _this.addClass(_class).next().slideToggle();
    }
  });

  $(document).mouseup(function(e){
    var container = $(".top-menu__link");
    if (!container.is(e.target) && container.has(e.target).length === 0){
      container.removeClass('active').next().slideUp();
    }
  });
});
